...
export default function TeamCard({ image, name, major, role }) {
    return (
        <div className="flex flex-row flex-wrap items-start content-start p-0 gap-[40px] w-[740px] h-[268px] flex-none order-0 self-stretch flex-grow-0">
            <img className="w-[268px] h-[268px] flex-none order-0 flex-grow-0 object-cover" src={image} alt="image"/>
            <div className="flex flex-col items-start gap-[20px] w-[166px] h-[110px] flex-none order-1 flex-grow-0">
                ...
                <div className="box-border flex flex-row justify-center items-center px-3 py-1.5 w-[166px] h-[32px] border border-[#5E5469] rounded-[20px] flex-none order-1 flex-grow-0 text-[#FDFCFD] tracking-wider">
